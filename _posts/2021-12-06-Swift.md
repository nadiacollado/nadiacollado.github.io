...
Because Swift is statistically typed, we must declare the type of the parameter(s) that are passed in to every function in addition to the name of the parameter. 
