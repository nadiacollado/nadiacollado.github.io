...
You can eliminate the need to check for nil by using optional binding. Swift unwraps the optional and assigns the value to a constant if it the optional contains a value. 
